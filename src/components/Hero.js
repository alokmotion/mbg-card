...
const Hero = () => {
  ...
  return (
    <section className="min[768px]:p-0 px-10 max-[398px]:w-[min-content]  dark:text-gray-100">
      <div className="container flex flex-col-reverse	 justify-center p-6 max-[450px]:p-[0.5rem] mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            ...
            <a
              href="#_"
              class="relative px-5 py-3 overflow-hidden  font-medium w-[220px] flex justify-center  text-gray-600 bg-white border border-b-4 border-indigo-500  border-gray-100 rounded-lg shadow-inner group"
            >
